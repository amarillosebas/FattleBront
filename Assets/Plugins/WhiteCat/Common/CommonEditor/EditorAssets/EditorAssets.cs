...
namespace WhiteCat.Editor
{
	...
	public class EditorAssets : FolderLocator<EditorAssets>
	{
        ...
        public static readonly Texture rotateTexture;
        public static readonly Texture lockRatioTexture;
        ...
        static EditorAssets()
		{
            ...
            LoadAsset(ref rotateTexture, "rotate.png");
            LoadAsset(ref lockRatioTexture, "lockRatio.png");
        }
        ...
        private static GUIStyle _miniImageButtonGUIStyle;
        /// <summary> 图像按钮风格 </summary>
        public static GUIStyle miniImageButtonGUIStyle
        {
            get
            {
                if (_miniImageButtonGUIStyle == null)
                {
                    _miniImageButtonGUIStyle = new GUIStyle(EditorStyles.miniButton);
                    _miniImageButtonGUIStyle.padding = new RectOffset();
                }
                return _miniImageButtonGUIStyle;
            }
        }
