...
namespace WhiteCat.Paths
{
	...
	public partial class Path
	{
		...
		void DoDrawGizmos()
		{
			...
			EditorUI.BeginHandlesMatrix(ref _pathMatrix);
			...
			EditorUI.BeginHandlesColor(_highlightColor);
		...
		protected sealed override void Editor_OnInspectorGUI()
		{
			...
			_alwaysVisible = EditorUI.IndentedToggleButton("Always Visible", _alwaysVisible);
		}
